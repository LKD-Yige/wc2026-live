...
const data = {
  ...
  matchesToday: [
    { id: "m17", date: "2026-06-16", time: "15:00", stage: "Group Stage", group: "I", homeTeam: "FRA", awayTeam: "SEN", venue: "MetLife Stadium", city: "New York", status: "upcoming" },
...
console.log(`   16 matches, 40 goals, 8 groups`);
