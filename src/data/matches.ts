...
export const remainingMatches: Match[] = [
  ...
  m("m49", "2026-06-25", "01:00", "Group Stage", "A", "CZE", "MEX", "Mexico City", "Estadio Azteca", "finished", 0, 1),
  m("m50", "2026-06-25", "01:00", "Group Stage", "A", "RSA", "KOR", "Monterrey", "Estadio BBVA", "finished", 0, 0),
