...
export const remainingMatches: Match[] = [
  ...
  m("m55", "2026-06-26", "22:00", "Group Stage", "D", "TUR", "USA", "Los Angeles", "SoFi Stadium", "upcoming"),
  m("m56", "2026-06-26", "22:00", "Group Stage", "D", "PAR", "AUS", "Seattle", "Lumen Field", "upcoming"),
  ...
  m("m59", "2026-06-26", "07:00", "Group Stage", "F", "JPN", "SWE", "Atlanta", "Mercedes-Benz Stadium", "live", 0, 0),
  m("m60", "2026-06-26", "07:00", "Group Stage", "F", "TUN", "NED", "Kansas City", "Arrowhead Stadium", "live", 0, 2),
