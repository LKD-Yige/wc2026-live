...
export const remainingMatches: Match[] = [
  ...
  m("m46", "2026-06-24", "17:00", "Group Stage", "L", "ENG", "GHA", "Foxborough", "Gillette Stadium", "finished", 0, 0),
  m("m47", "2026-06-24", "19:00", "Group Stage", "L", "PAN", "CRO", "Toronto", "BMO Field", "finished", 0, 1),
  // MD3: June 27 - July 1
  ...
  m("m61", "2026-06-26", "23:00", "Group Stage", "G", "EGY", "IRN", "Seattle", "Lumen Field", "upcoming"),
  m("m62", "2026-06-26", "23:00", "Group Stage", "G", "NZL", "BEL", "Vancouver", "BC Place", "upcoming"),
  m("m63", "2026-06-26", "20:00", "Group Stage", "H", "URU", "ESP", "Guadalajara", "Estadio Akron", "upcoming"),
  m("m64", "2026-06-26", "20:00", "Group Stage", "H", "CPV", "KSA", "Houston", "NRG Stadium", "upcoming"),
  m("m65", "2026-06-26", "15:00", "Group Stage", "I", "NOR", "FRA", "Foxborough", "Gillette Stadium", "upcoming"),
  m("m66", "2026-06-26", "15:00", "Group Stage", "I", "SEN", "IRQ", "Toronto", "BMO Field", "upcoming"),
  ...
  m("m69", "2026-06-24", "13:00", "Group Stage", "K", "POR", "UZB", "Houston", "NRG Stadium", "finished", 5, 0),
