...
export const standings: Record<string, StandingEntry[]> = {
  ...
  "B": [
    { fifaCode: "CAN", played: 3, won: 1, drawn: 2, lost: 0, goalsFor: 7, goalsAgainst: 2, points: 5 },
    { fifaCode: "SUI", played: 3, won: 1, drawn: 2, lost: 0, goalsFor: 5, goalsAgainst: 3, points: 5 },
    { fifaCode: "BIH", played: 3, won: 1, drawn: 1, lost: 1, goalsFor: 4, goalsAgainst: 4, points: 4 },
    { fifaCode: "QAT", played: 3, won: 0, drawn: 1, lost: 2, goalsFor: 2, goalsAgainst: 9, points: 1 },
  ],
  "C": [
  ...
  "E": [
    { fifaCode: "GER", played: 2, won: 2, drawn: 0, lost: 0, goalsFor: 9, goalsAgainst: 2, points: 6 },
    { fifaCode: "CIV", played: 2, won: 1, drawn: 0, lost: 1, goalsFor: 2, goalsAgainst: 2, points: 3 },
    { fifaCode: "ECU", played: 2, won: 0, drawn: 1, lost: 1, goalsFor: 0, goalsAgainst: 1, points: 1 },
    { fifaCode: "CUW", played: 2, won: 0, drawn: 1, lost: 1, goalsFor: 1, goalsAgainst: 7, points: 1 },
  ],
  "F": [
    { fifaCode: "NED", played: 2, won: 2, drawn: 0, lost: 0, goalsFor: 7, goalsAgainst: 3, points: 6 },
    { fifaCode: "SWE", played: 2, won: 1, drawn: 0, lost: 1, goalsFor: 6, goalsAgainst: 3, points: 3 },
    { fifaCode: "JPN", played: 2, won: 1, drawn: 1, lost: 0, goalsFor: 6, goalsAgainst: 2, points: 4 },
    { fifaCode: "TUN", played: 2, won: 0, drawn: 0, lost: 2, goalsFor: 1, goalsAgainst: 9, points: 0 },
  ],
  "G": [
