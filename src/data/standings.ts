...
export const standings: Record<string, StandingEntry[]> = {
  ...
  "G": [
    { fifaCode: "NZL", played: 2, won: 1, drawn: 1, lost: 0, goalsFor: 3, goalsAgainst: 2, points: 4 },
    ...
    { fifaCode: "EGY", played: 2, won: 0, drawn: 1, lost: 1, goalsFor: 1, goalsAgainst: 3, points: 1 },
  ],
  "H": [
